...
2. Run,
   ...
   ```
3. Run `cd ..` twice until you get into the root folder `ComfyUI_windows_portable`
4. Run,
   ```bash
   .\python_embeded\python.exe -m pip install -r .\ComfyUI\custom_nodes\ComfyUI-Voice-Clone\requirements.txt
   ```
5. Restart ComfyUI
